...
def button_start():
    ...
    while True:
        if e.get() != "":
            ...
            app.main(input_file_path= (os.path.abspath(os.path.dirname(__file__)) + "\\PV\\" + e.get() + ".mp4"))
            break
            ...
            app.main(input_file_path=(os.path.abspath(os.path.dirname(__file__)) + "\\PV\\" + str(k) + ".mp4"))
            break
        else:
            k = k + 1
            continue
